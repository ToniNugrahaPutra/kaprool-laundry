<div class="container">
	<div class="row mt-3 justify-content-center">
		<div class="col-md-6">
			...
			<form action="<?= base_url('kurir/edit_status') ?>" method="post">

			<h1 class="mb-5" style="color: grey;text-align: center">Update Status by Kurir</h1>
			  	...
			  	<div class="card-body">
				    ...
				    <div class="form-group">
				    	...
				    	<select class="custom-select" name="status_cucian" id="status_cucian">
							...
							<option value="Pengambilan Laundry">Pengambilan Laundry</option>
							<option value="Pengiriman Laundry">Pengiriman Laundry</option>
